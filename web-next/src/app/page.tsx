...
export default function LandingPage() {
  ...
  // بعد نجاح تسجيل الدخول (أي طريقة)، نتأكد من مستند المستخدم في users
  // ونوجهه للمكان الصح (onboarding أو dashboard)
  async function routeAfterAuth(role: Role) {
    ...
    // التوجيه الفعلي للداشبورد المناسب هيتضاف في الخطوة الجاية
    // (لسه مش عملنا صفحات /seeker و /employer)
    if (role === "job_seeker") {
      router.push("/seeker");
    } else {
  ...
  return (
    <div dir="rtl" style={{ maxWidth: 900, margin: "0 auto", padding: "40px 20px" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 40 }}>
        ...
        >
          🎉 التسجيل والتقديم على أي وظيفة مجاني ١٠٠٪ للباحثين عن عمل — وهيفضل مجاني دايمًا
        </div>
      </div>
